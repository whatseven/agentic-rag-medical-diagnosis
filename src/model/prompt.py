...
- 如果有2个或更多疾病的症状匹配度相近，且都有较好的匹配度(similarity > 0.75)，才需要图数据库提供更多信息进行区分
...
分析示例：
患者症状：腹痛、恶心
候选疾病：胃炎(症状:腹痛,恶心,相似度0.95)、阑尾炎(症状:腹痛,发热,相似度0.74)、肾结石(症状:腰痛,血尿,相似度0.45)
分析：胃炎症状完全匹配且相似度最高，明显优于其他候选疾病。可以直接诊断为胃炎，无需查询图数据库。返回need_more_info: false。

反例：
患者症状：腹痛、腹泻
候选疾病：急性胃肠炎(症状:腹痛,腹泻,相似度0.92)、肠炎(症状:腹痛,腹泻,相似度0.85)、产气杆菌肠炎(症状:腹痛,腹泻,相似度0.81)
